...
namespace Aliyun.Acs.Core.Auth
{
    public class ShaHmac1 : ISigner
    {
        ...
        public override String SignString(String source, String accessSecret)
        {
            ...
            //}
            using (var hashAlgorithm = new HMACSHA1(Encoding.UTF8.GetBytes(source.ToCharArray())))
            {
                hashAlgorithm.Key = Encoding.UTF8.GetBytes(accessSecret.ToCharArray());
                return Convert.ToBase64String(
                hashAlgorithm.ComputeHash(Encoding.UTF8.GetBytes(source.ToCharArray())));
            }
        }
    }
}
